...
- (void)viewDidLoad
{
    ...
    self.headerImageView = [[UIImageView alloc] initWithImage: [UIImage imageNamed: @"DUTHeader" inBundle: [NSBundle bundleForClass: [self class]] compatibleWithTraitCollection:nil]];
